...
export interface BaseLeagueContract
  extends Truffle.Contract<BaseLeagueInstance> {
  "new"(
    _commish: string,
...
export interface BaseLeagueInstance extends Truffle.ContractInstance {
